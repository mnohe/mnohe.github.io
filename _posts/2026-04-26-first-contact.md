...
This is a real limitation, not a philosophical party trick. A model that has read every cookbook can describe a salty soup without tasting salt. It can reason about apples without ever holding one. It has the statistical silhouette of the world, not the world itself. Robin Williams makes the point better in _Good Will Hunting_ than I am going to manage here. However, the remarkable thing is not that this is insufficient. The remarkable thing is that the silhouette is dense enough to support anything resembling thought at all.
